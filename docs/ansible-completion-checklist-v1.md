...
- 2026-03-02: rollout disposition recorded in `docs/evidence/mvp1/20260302-deploy-smoke.md` (`fb0ea79` deployed; mac/vps/mbp restarted; cross-gateway smoke conversation `mvp1-close-1772477060` verified in message dumps).
